...
const tracker = {
    ...
    enableRigged: false, // bool, enable or disable rigged body visual
    ...
    video: null, // DOMElement with video
    ...
    setupCamera: async function() {
        ...
        // /* -=- Custom Fix: Set canvas to stream width & height -=- */
        document.getElementById( 'canvas' ).width = stream_width
        document.getElementById( 'canvas' ).height = stream_height
        // /* -=- End Custom Fix */
    ...
    cameraFrame: async function() {
        ...
        // TODO: This is being slow, needs fixing
